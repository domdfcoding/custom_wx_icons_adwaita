...
.. tabs::
	...
	.. tab:: from PyPI
		...
		.. prompt:: bash
			...
			python3 -m pip install wx_icons_adwaita --user
	...
	.. tab:: from GitHub
		...
		.. prompt:: bash
			...
			python3 -m pip install git+https://github.com/domdfcoding/custom_wx_icons_adwaita@master --user
...
`Browse the GitHub Repository <https://github.com/domdfcoding/custom_wx_icons_adwaita>`__
